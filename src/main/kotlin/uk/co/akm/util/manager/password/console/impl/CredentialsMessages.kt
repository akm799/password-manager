...
val addCredentialsNameInstruction = "Enter the name for this item (e.g. 'Gmail' or 'Facebook'):"
val addCredentialsFirstKeyInstruction = "Enter the key (e.g. 'login-name' or 'URL'):"
val addCredentialsOtherKeyInstruction = "Enter another key (e.g. 'password' or 'authorisation-code') or an empty line to finish:"
val addCredentialsValueInstruction = "Enter the value for '%s':"
